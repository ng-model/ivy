...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["auth-auth-module"], {
  ...
  function srcAppAuthVerifyEmailVerifyEmailComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    VerifyEmailComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 19,
      vars: 1,
      consts: [[1, "login-register", 2, "background-image", "url('assets/images/login.jpg')"], [1, "login-box", "card"], [1, "card-body", "auth"], [1, "display-4"], ["class", "form-group", 4, "ngIf"], [1, "form-group", "text-center"], ["type", "button", 1, "btn", "btn-outline-primary", 3, "click"], [1, "fas", "fa-redo-alt"], [1, "or"], [1, "orInner"], ["routerLink", "/auth/login"], [1, "form-group"], [1, "text-center"]],
