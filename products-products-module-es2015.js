...
function InventoryComponent_ng_template_30_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function InventoryComponent_ng_template_30_Template_button_click_3_listener() { const modal_r4 = ctx.$implicit; return modal_r4.dismiss("Cross click"); });
...
InventoryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: InventoryComponent, selectors: [["app-inventory"]], decls: 32, vars: 1, consts: [["role", "main", 1, "content"], [1, "container"], [1, "d-flex", "justify-content-between"], ["routerLink", "/products/home"], ["aria-hidden", "true", 1, "fa", "fa-arrow-left"], [1, "btn", "btn-primary", 3, "click"], [1, "card-body"], [1, "table-responsive"], [1, "table", "table-hover"], [1, "text-nowrap"], ["class", "text-nowrap", 4, "ngFor", "ngForOf"], ["addItem", ""], [1, "modal-header"], ["id", "modal-additem", 1, "modal-title"], ["type", "button", "aria-label", "Close", 1, "close", 3, "click"], ["aria-hidden", "true"], [1, "modal-body"], ["novalidate", "", 3, "formGroup"], [1, "form-group"], ["for", "key"], ["type", "number", "id", "key", "value", "", "placeholder", "key", "formControlName", "key", "required", "", 1, "form-control"], ["for", "id"], ["type", "number", "id", "id", "value", "", "placeholder", "ID", "formControlName", "id", "required", "", 1, "form-control"], ["for", "title"], ["type", "text", "id", "title", "value", "", "placeholder", "title", "formControlName", "title", "required", "", 1, "form-control"], ["for", "price"], ["type", "number", "id", "password", "value", "", "placeholder", "0.00", "formControlName", "price", "required", "", 1, "form-control"], ["for", "category"], ["type", "text", "id", "category", "value", "", "placeholder", "category", "formControlName", "category", "required", "", 1, "form-control"], ["for", "url"], ["type", "text", "id", "url", "value", "", "placeholder", "Image url", "formControlName", "imageUrl", "required", "", 1, "form-control"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-outline-dark", 3, "click"]], template: function InventoryComponent_Template(rf, ctx) { if (rf & 1) {
